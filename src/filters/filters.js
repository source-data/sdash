...
Vue.filter('mimeExtension', item => {
	...
	if (mimetypes[`${item.mimetype}/${item['mime-subtype']}`] !== undefined) return mimetypes[`${item.mimetype}/${item['mime-subtype']}`];
	return item['mime-subtype']
})