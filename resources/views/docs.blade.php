...
<script src="https://cdnjs.cloudflare.com/ajax/libs/prism/1.23.0/components/prism-json.min.js" defer></script>
@endsection
...
<div class="container">
    <div class="row" style="margin: 50px auto;">
        ...
        <div class="col-md-10">
            ...
            <p>
                The SDash API is organized around REST. It has predictable resource-oriented URLs,
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>load a page of results (results are provided in pages of 20 records – i.e. page 2 = records 21-40)</td>
                            </tr>
                            <tr>
                                <td>search</td>
                            ...
                            <tr>
                                ...
                                <td><code>body</code></td>
                                <td><code>optional</code></td>
                                <td>the tag identifiers of any of the existing tags in the database</td>
                            </tr>
                            <tr>
                                <td>authors</td>
                                <td>
                                ...
                                <td><code>body</code></td>
                                <td><code>optional</code></td>
                                <td>the user identifiers or ORCIDs of any of the registered authors in the database</td>
                            </tr>
                            <tr>
                                <td>sortOrder</td>
                                <td><code>string</code></td>
                                <td><code>body</code></td>
                                <td><code>optional</code></td>
                                <td>defines the order of the records returned (one of: modification-date-asc, modification-date-desc,
                                    creation-date-asc, creation-date-desc, title-asc, title-desc)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    "DATA": [
        ...
        },
        {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-primary" role="alert">
                        Returns a thumbnail of the original image (300px in height).
                    </div>
                </div>
            </div>
            <!-- Panel Thumbnail [END] -->
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>text that will be matched against names of users</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><code>body</code></td>
                                <td><code>required</code></td>
                                <td>text that will be matched against tag labels</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
