...
class SDPDF extends TCPDF {
    ...
    public function __construct(string $title, string $caption, string $imagePath, string $imageFormat = null)
    {
    ...
    public function generateAndReturn()
    {
        ...
        if ($this->imageFormat == 'svg') {
            ...
            $this->Image($this->imagePath, $x='', $y='', $w=160, $h=240, $type='', $link='', $align='',
            $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0,
            $fitbox='C M', $hidden=false);
